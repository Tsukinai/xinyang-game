...
Object.assign(DATA.zones, {
  ...
  z_blackelf:{ id:'z_blackelf', name:'黑精灵部落集结地', cityId:'saturn', levelRange:[150,180], icon:'🕷️',
    desc:'每天清晨大量玩家在此组团前往黑精灵部落。', encounters:[{m:'sandgiant',w:3},{m:'silverwing',w:2}], rare:[{m:'dilakru',chance:0.01}] },
...
Object.assign(DATA.dungeons, {
  ...
  d_battle:{ id:'d_battle', name:'失落的巴特尔城', cityId:'saturn', levelRange:[150,160], icon:'🏯',
    ...
    desc:'聂言开启的地底古城，黄沙巨人成群。', waves:['sandgiant','sandgiant','silverwing'], boss:'aina2',
...
Object.assign(DATA.quests, {
  ...
  q_order_fairness:{ id:'q_order_fairness', name:'【隐藏】公正之章', type:'hidden', cityId:'element', giver:'探索触发', reqLevel:95,
    desc:'公正之章附带群体治疗术的神力，藏于黄金之城伊格林宝库。',
    objective:{kind:'clear',target:'d_goldcity',label:'通关黄金之城宝库'},
    rewards:{xp:800000,gold:20000,orderChapter:'公正'} },
  // 终局传奇
  q_assassin_heart:{ id:'q_assassin_heart', name:'【传奇】寻找刺客之心', type:'side', cityId:'saturn', giver:'布莱兹酋长', reqLevel:150,
    desc:'刺客之心的线索在黑精灵部落的中央祭坛。夺取帕特诺斯特战锤，于失落的巴特尔城以雷击绝杀被恶魔操控的迪拉克鲁，方得刺客之心（全属性+30%）。',
